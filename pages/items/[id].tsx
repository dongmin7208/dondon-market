    ...
    <div className='px-4 py-10'>
      <div className='mb-8'>
        ...
        <div className='mt-10'>
          ...
          <div className='flex items-center justify-between space-x-2'>
            <button
              title='button'
              className='flex-1 py-3 font-medium text-white bg-orange-500 rounded-md focus:outline-none focus:ring-2 hover:bg-orange-600 focus:ring-offset-2 focus:ring-orange-500'
            >
              Talk to seller
            </button>
            <button
      ...
      <div className=''>
        ...
        <div className='grid grid-cols-2 gap-4'>
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              <div className='w-full h-56 mt-6 mb-4 bg-slate-300' />
